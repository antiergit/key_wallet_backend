export const language: any = {
    en: {
        ...
        CHANGE_MAX_AMOUNT: (crytpAmount: string, coinSymbol: string) => `Maximum amount is ${crytpAmount} ${coinSymbol}.`
    },
    sp: {
        //Wallets
        ...
        CHANGE_MAX_AMOUNT: (crytpAmount: string, coinSymbol: string) => `La cantidad máxima es ${crytpAmount} ${coinSymbol}.`
