...
import { ChangellySupportedCrossChainCoinsInterface } from "../index";
...
const ChangellySupportedCrossChainCoinsModel = db.db_write.define<ChangellySupportedCrossChainCoinsInstance>(
    "changelly_supported_cross_chain_coins",
    dataObj
);

export default ChangellySupportedCrossChainCoinsModel;
